 ...
 * @author deadp
 */
public class Resultados_Revanchita extends javax.swing.JFrame {
    Conexion con = new Conexion();
    Connection cn = con.conectar();
    /**
     * Creates new form Resultados
     */
    public Resultados_Revanchita() {
        initComponents();
    ...
    model.addColumn("adicional2");
    jTable3.setModel(model);

    // Consulta SQL con una consulta preparada
    String query = "SELECT num1,num2,num3,num4,num5,num6,adicional1,adicional2 FROM revanchita WHERE fechaSorteo = ? and usuario = ?";
    ...
    // Consulta SQL con una consulta preparada
    String query2 = "SELECT num1,num2,num3,num4,num5,num6,adicional1,adicional2 FROM numganadores_revanchita WHERE fecha = ?";
    ...
    // Consulta SQL con una consulta preparada
    String query = "SELECT " +
                   "(CASE WHEN revanchita.num1 = numganadores_revanchita.num1 THEN 1 ELSE 0 END + " +
                   " CASE WHEN revanchita.num2 = numganadores_revanchita.num2 THEN 1 ELSE 0 END + " +
                   " CASE WHEN revanchita.num3 = numganadores_revanchita.num3 THEN 1 ELSE 0 END + " +
                   " CASE WHEN revanchita.num4 = numganadores_revanchita.num4 THEN 1 ELSE 0 END + " +
                   " CASE WHEN revanchita.num5 = numganadores_revanchita.num5 THEN 1 ELSE 0 END + " +
                   " CASE WHEN revanchita.num6 = numganadores_revanchita.num6 THEN 1 ELSE 0 END + " +
                   " CASE WHEN revanchita.adicional1 = numganadores_revanchita.adicional1 THEN 1 ELSE 0 END + " +
                   " CASE WHEN revanchita.adicional2 = numganadores_revanchita.adicional2 THEN 1 ELSE 0 END) AS num_identicos " +
                   "FROM " +
                   "revanchita " +
                   "JOIN " +
                   "numganadores_revanchita " +
                   "WHERE " +
                   "revanchita.fechaSorteo = ? AND numganadores_revanchita.Fecha = ? and usuario = ? ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Resultados Revanchita");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Resultados_Revanchita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

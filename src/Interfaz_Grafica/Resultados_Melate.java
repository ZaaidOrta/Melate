 ...
 * @author deadp
 */
public class Resultados_Melate extends javax.swing.JFrame {
    ...
    public Resultados_Melate() {
        initComponents();
        jTextField1.setEditable(false);
        agregarFechaActual(jTextField1);
    }
     private static void agregarFechaActual(JTextField textField) {
   ...
   public void mostrarTabla1() {
    ...
    String query = "SELECT num1,num2,num3,num4,num5,num6 FROM melate WHERE fechaSorteo = ? and usuario = ?";
    ...
    // Consulta SQL con una consulta preparada
    String query2 = "SELECT num1,num2,num3,num4,num5,num6 FROM numganadores_melate WHERE fecha = ?";
...
public String obtenerNumIdenticos() {
    ...
    // Consulta SQL con una consulta preparada
    String query = "SELECT " +
                   "(CASE WHEN melate.num1 = numganadores_melate.num1 THEN 1 ELSE 0 END + " +
                   " CASE WHEN melate.num2 = numganadores_melate.num2 THEN 1 ELSE 0 END + " +
                   " CASE WHEN melate.num3 = numganadores_melate.num3 THEN 1 ELSE 0 END + " +
                   " CASE WHEN melate.num4 = numganadores_melate.num4 THEN 1 ELSE 0 END + " +
                   " CASE WHEN melate.num5 = numganadores_melate.num5 THEN 1 ELSE 0 END + " +
                   " CASE WHEN melate.num6 = numganadores_melate.num6 THEN 1 ELSE 0 END) AS num_identicos " +
                   "FROM " +
                   "melate " +
                   "JOIN " +
                   "numganadores_melate " +
                   "WHERE " +
                   "melate.fechaSorteo = ? AND numganadores_melate.Fecha = ? and usuario = ? ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Resultados Melate");
        ...
        txtpremio.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txtpremio, javax.swing.GroupLayout.DEFAULT_SIZE, 251, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Resultados_Melate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

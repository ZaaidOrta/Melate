 ...
 * @author deadp
 */
public class Numero_Ganador_Revanchita extends javax.swing.JFrame {
     ...
     */
    public Numero_Ganador_Revanchita() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Numero Ganador Revanchita");
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        try {
            ...
            PreparedStatement ps = cn.prepareStatement("INSERT INTO numganadores_revanchita(num1,num2,num3,num4,num5,num6,adicional1,adicional2,Fecha) VALUES (?,?,?,?,?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Numero_Ganador_Revanchita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
